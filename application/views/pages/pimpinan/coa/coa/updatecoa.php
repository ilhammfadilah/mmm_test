      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category"><?php echo $this->lang->line('change'); ?> Data COA</p>
          </div>
          <div class="card-body">
            <h4>Data COA</h4>
            <hr>
            <?php foreach ($coa as $data) {
              ?>
            <form action="<?php echo base_url() . 'pimpinan/updatecoa'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
