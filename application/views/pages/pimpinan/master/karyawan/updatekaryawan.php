      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category"><?php echo $this->lang->line('change'); ?> Data <?php echo $this->lang->line('employee'); ?></p>
          </div>
          <div class="card-body">
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                  ...
                  <select  name="bagian" class="form-control" required >
                        <option value="<?=$data->bagian?>"><?php echo $this->lang->line('part'); ?> <?php echo $this->lang->line('early'); ?> : <?=$data->bagian?></option>
                        <?php
