      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title">Form Data <?php echo $this->lang->line('typedesign'); ?></h4>
            <p class="card-category">Edit Data <?php echo $this->lang->line('typedesign'); ?></p>
          </div>
          <div class="card-body">
            <h4>Data <?php echo $this->lang->line('typedesign'); ?></h4>
            <hr>
             <?php
             foreach($tipedesign as $data){
             
            ?>
            <form action="<?php echo base_url() . 'pimpinan/updatetipedesign'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
