      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category">Edit Data <?php echo $this->lang->line('producttype'); ?></p>
          </div>
          <div class="card-body">
            ...
            ?>
            <form action="<?php echo base_url() . 'pimpinan/updatetipeproduk'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input style="padding-bottom: 10px;" type="text" name="tipeproduk" class="form-control" value="<?= $data->tipeproduk ?>" required>
