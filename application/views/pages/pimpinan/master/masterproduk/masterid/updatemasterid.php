      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            ...
            <p class="card-category"><?php echo $this->lang->line('change'); ?> Data MasterID</p>
          </div>
          <div class="card-body">
            <h4>Data MasterID</h4>
            <hr>
            ...
            ?>
            <form action="<?php echo base_url() . 'pimpinan/updatemasterid'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
