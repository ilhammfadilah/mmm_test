      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title">Form Data <?php echo $this->lang->line('material'); ?></h4>
            <p class="card-category">Edit Data <?php echo $this->lang->line('material'); ?></p>
          </div>
          <div class="card-body">
            <h4>Data <?php echo $this->lang->line('material'); ?></h4>
            <hr>
             <?php
             foreach($material as $data){
             
            ?>
            <form action="<?php echo base_url() . 'pimpinan/updatematerial'; ?> " enctype="multipart/form-data" method="post" accept-charset="utf-8" aria-hidden="true">
              <div class="row">
                <div class="col-md-6">
